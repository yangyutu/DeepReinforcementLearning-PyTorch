...
config['currentState'] = [0, 0, 20, 0.511603, 0.384632, 0.768323]
config['currentState'] = [0, 0, 20, 0., 0., 1]
...
config['gravity'] = 0
config['multiMapNames'] = ['config_RBC_R50_FTest.json']
...
for i in range(nTraj):
    ...
    for stepCount in range(endStep):
        ...
        done = (np.linalg.norm((pos[2:] - finalTarget[2:]), ord=np.inf) < 5.0)
