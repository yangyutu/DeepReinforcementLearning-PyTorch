...
from Env.CustomEnv.ThreeDNavigation.NavigationExamples.optimalSearch.pathGuider import PathGuiderStraightLine, PathGuiderStraightLineReverse
...
config['gravity'] = 0
config['multiMapNames'] = ['config_RBC_R25_10PerTest.json']
