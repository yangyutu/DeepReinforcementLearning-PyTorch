...
config['currentState'] = [-20, -20, 1, 0, 0, 1]
...
for i in range(nTraj):
    ...
    for stepCount in range(endStep):
        ...
        dynamicObsMover.simulate(steps=1, translationStepSize=1, rotationStepSize=0.0743)
        dynamicObsMover.saveObstacles()
    ...
    np.savetxt('Traj/testTraj_target_'+str(i)+'.txt', recorderNumpy, fmt='%.3f')
