...
from Env.CustomEnv.ThreeDNavigation.NavigationExamples.optimalSearch.pathGuider import PathGuider
...
checkpoint = torch.load('../../Multimaps/TrainTwoObsPenalNew/Log/Epoch75000_checkpoint.pt')
