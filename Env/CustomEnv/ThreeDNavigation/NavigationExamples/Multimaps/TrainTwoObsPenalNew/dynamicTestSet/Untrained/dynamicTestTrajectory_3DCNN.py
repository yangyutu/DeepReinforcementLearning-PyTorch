...
from Env.CustomEnv.ThreeDNavigation.dynamicObstacleMover import DynamicObstacleMover
...
np.savetxt('Traj/testTraj_target_'+str(i)+'.txt', recorder, fmt='%.3f')
dynamicObsMover.outputObstacles('Traj/testTraj_Obs_'+str(i)+'.txt')